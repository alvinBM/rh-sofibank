...
export default function RolesPage() {
  ...
  const { data: permissionsData } = useGetPermissions({ page: 1, rowsPerPage: 1000 });
      ...
      <div className="p-6">
        ...
        >
          ...
          <TableBody
            ...
            emptyContent="Aucun rôle trouvé"
          >
            {(role) => (
        ...
        >
          <ModalContent>
            {(onClose) => (
              <>
                <ModalHeader>
                  Gérer les permissions - {selectedRole?.name}
                </ModalHeader>
                <ModalBody>
                      ...
                      <Tab key={module} title={module}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-4">
                          {modulePermissions.map((permission) => (
                            <div
                              key={permission.id}
                              className="flex items-start gap-3 p-3 border rounded-lg hover:bg-default-100"
                            >
                              <Checkbox
