                        ...
                        <div className="flex items-start gap-6">
                            ...
                            <div className="flex-1">
                                <div className="flex items-start justify-between mb-4">
                                    ...
                                    <Chip color={EMPLOYMENT_STATUS_COLORS[employee.employment_status] || "default"} variant="flat">
                            ...
                            <CardBody>
                                ...
                                <div className="grid grid-cols-3 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-semibold">{employee.gender === "M" ? "Masculin" : employee.gender === "F" ? "Féminin" : "-"}</p>
                                    </div>
                                    <div>
                                                ...
                                                <CardBody>
                                                    <div className="flex gap-4">
                                                        <div className="flex-1">
                                                            ...
                                                            <p className="text-xs text-default-400 mt-2">{new Date(event.event_date).toLocaleDateString("fr-FR")}</p>
                                                        </div>
                                                    </div>
                                                </CardBody>
                                            </Card>
                    ...
                    >
                        <Card className="mt-4">
                            <CardBody>
                                ...
                                <p className="text-center text-default-400 py-8">Les évaluations de performance seront affichées ici</p>
                            </CardBody>
                        </Card>
                    </Tab>
                </Tabs>
