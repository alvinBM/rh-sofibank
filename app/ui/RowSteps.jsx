...
const RowSteps = React.forwardRef(({ color = "danger", steps = [], defaultStep = 0, onStepChange, currentStep: currentStepProp, hideProgressBars = false, stepClassName, className, ...props }, ref) => {
                        ...
                        <li key={stepIdx} className="relative flex w-full items-center pr-12">
                            ...
                            >
                                ...
                                <div className="max-w-full flex-1 text-start">
                                    <div
                                        className={cn("text-small font-medium text-default-foreground transition-[color,opacity] duration-300 group-active:opacity-80 lg:text-medium", {
