                            ...
                            >
                                <div className="h-ful relative flex items-center">
                                    ...
                                    {stepIdx < steps.length - 1 && !hideProgressBars && (
                                        <div
                                            aria-hidden="true"
                                            className={cn("pointer-events-none absolute left-6 top-1/2 flex w-8 -translate-y-1/2 translate-x-1/2 items-center sm:w-12")}
                                            style={{
                                                // @ts-ignore
                                                "--idx": stepIdx,
                                            }}
                                ...
                                <div className="max-w-[100px] flex-1 px-2 text-center lg:max-w-[120px]">
                                    <div
                                        className={cn("line-clamp-2 text-small font-medium text-default-foreground transition-[color,opacity] duration-300 group-active:opacity-80 lg:text-medium", {
